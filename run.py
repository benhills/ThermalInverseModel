...
m_init = np.array([0.06148453, 1.32109605, 7.33058424, 6.31995724, 4.53084996, 3.58193804,
                    2.85807974, 1.94213404, 0.58012404, 0.1134321,  0.27526652, 3.08104113])
# Model step
m_step = np.array([0.001,0.01])
...
simulated_annealing(f,reg,m_init,m_step,m_min,m_max,t_m,kmax=500,save_names=['./output/Models1','./output/Pred_Data1','./output/Cost1'],restart=False)
